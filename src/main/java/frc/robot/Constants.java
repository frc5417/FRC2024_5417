...
public final class Constants {
  ...
  public static class MotorConstants {
    ...
    public static final Double[] motorDegrees =
     {271.67004, 22.76352, 58.7988, 211.28904};
  ...
  public static class Auton {
    ...
    public static final PIDController X_Pos = new PIDController(1.8, 0, 0); // new PIDController(1.8, 0, 0);
    public static final PIDController Y_Pos = new PIDController(1.8, 0, 0); // 1.3, 0, 0.1
